  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{completionStats.completed}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{completionStats.partial}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{completionStats.abandoned}</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <h3 className="text-lg font-medium text-gray-900 mb-6">Completion Status Distribution</h3>
          <div className="h-80">
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center">
              ...
              <h3 className="text-lg font-medium text-gray-900">Incomplete Responses</h3>
            </div>
            <button
              ...
              <thead className="bg-gray-50">
                <tr>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <input
                      type="checkbox"
                      checked={selectedResponses.length === incompleteResponses.length}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div 
                          ...
                          style={{ width: `${(response.completedSections / response.totalSections) * 100}%` }}
                        ></div>
                      </div>
                      <span className="text-sm text-gray-500 mt-1">
                        {response.completedSections}/{response.totalSections} sections
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="text-sm text-gray-500">{response.lastPage}</span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        onClick={() => {
                          toast.success(`Retargeting email sent to ${response.email}`);
                        }}
